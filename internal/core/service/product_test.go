...
func TestProductService_CreateProduct(t *testing.T) {
	t.Run("creates product, variants, prices and publishes", func(t *testing.T) {
		...
		got, err := svc.CreateProduct(context.Background(), "org_1", CreateProductInput{
			Name: "Plan",
			Variants: []CreateProductVariantInput{
				{Name: "Monthly", Prices: []CreateProductPriceInput{{Currency: "USD", UnitPrice: 1000}}},
			},
		})
	...
	t.Run("product create failure stops and does not publish", func(t *testing.T) {
		...
		_, err := svc.CreateProduct(context.Background(), "org_1", CreateProductInput{Name: "Plan"})
...
func TestProductService_UpdateProduct(t *testing.T) {
	t.Run("overwrites fields and publishes", func(t *testing.T) {
		...
		got, err := svc.UpdateProduct(context.Background(), "org_1", "prod_1", UpdateProductInput{Name: "New", Description: "d"})
	...
	t.Run("not found is rejected", func(t *testing.T) {
		...
		_, err := svc.UpdateProduct(context.Background(), "org_1", "prod_x", UpdateProductInput{Name: "New"})
...
func TestProductService_CreateProductPrice(t *testing.T) {
	t.Run("defaults empty intervals to none and publishes", func(t *testing.T) {
		...
		got, err := svc.CreateProductPrice(context.Background(), CreatePriceInput{OrgId: "org_1", Currency: "USD", UnitPrice: 500})
...
func TestProductService_Variants(t *testing.T) {
	t.Run("create publishes variant.created", func(t *testing.T) {
		...
		got, err := svc.CreateVariant(context.Background(), "org_1", "prod_1", CreateVariantInput{Name: "Monthly"})
	...
	t.Run("update overwrites and publishes", func(t *testing.T) {
		...
		got, err := svc.UpdateVariant(context.Background(), "org_1", "var_1", UpdateVariantInput{Name: "New"})
...
func TestProductService_Prices(t *testing.T) {
	t.Run("update overwrites and publishes", func(t *testing.T) {
		...
		got, err := svc.UpdatePrice(context.Background(), "org_1", "price_1", CreatePriceInput{Label: "New", Currency: "USD", UnitPrice: 700})

...
func (s *CustomerService) Create(ctx context.Context, orgId string, input port.CreateCustomerInput) (domain.Customer, error) {
...
func (s *CustomerService) CreatePaymentMethod(ctx context.Context, orgId string, input port.CreatePaymentMethodInput) (domain.PaymentMethod, error) {
...
func (s *CustomerService) UpdatePaymentMethod(ctx context.Context, orgId string, input port.UpdatePaymentMethodInput) (domain.PaymentMethod, error) {

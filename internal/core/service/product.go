...
func (s *ProductService) CreateProduct(ctx context.Context, orgId string, input CreateProductInput) (domain.Product, error) {
...
func (s *ProductService) CreateProductPrice(ctx context.Context, input CreatePriceInput) (domain.Price, error) {
...
func (s *ProductService) UpdateProduct(ctx context.Context, orgId string, id string, input UpdateProductInput) (domain.Product, error) {
	product, err := s.productRepository.FindById(ctx, orgId, id)
	if err != nil {
		s.logger.Error("Failed to find product", err.Error())
		return domain.Product{}, err
...
func (s *ProductService) CreateVariant(ctx context.Context, orgId string, productId string, input CreateVariantInput) (domain.Variant, error) {
...
func (s *ProductService) UpdateVariant(ctx context.Context, orgId string, id string, input UpdateVariantInput) (domain.Variant, error) {
	variant, err := s.variantRepository.FindById(ctx, orgId, id)
	if err != nil {
		s.logger.Error("Failed to find variant", err.Error())
		return domain.Variant{}, err
...
func (s *ProductService) UpdatePrice(ctx context.Context, orgId string, id string, input CreatePriceInput) (domain.Price, error) {
	price, err := s.priceRepository.FindById(ctx, orgId, id)
	if err != nil {
		s.logger.Error("Failed to find price", err.Error())
		return domain.Price{}, err

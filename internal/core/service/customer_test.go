...
func TestCustomerService_Create(t *testing.T) {
	t.Run("new email creates and publishes", func(t *testing.T) {
		...
		got, err := svc.Create(context.Background(), "org_1", domain.CreateCustomerInput{Email: "a@b.com", FirstName: "Ada"})
	...
	t.Run("existing email is rejected without persistence", func(t *testing.T) {
		...
		_, err := svc.Create(context.Background(), "org_1", domain.CreateCustomerInput{Email: "a@b.com"})
...
func TestCustomerService_CreatePaymentMethod(t *testing.T) {
	t.Run("uses input billing address, creates and publishes", func(t *testing.T) {
		...
		got, err := svc.CreatePaymentMethod(context.Background(), "org_1", domain.CreatePaymentMethodInput{
	...
	t.Run("rejects when no billing address can be resolved", func(t *testing.T) {
		...
		_, err := svc.CreatePaymentMethod(context.Background(), "org_1", domain.CreatePaymentMethodInput{CustomerId: "cus_1", Token: "tok_1"})
	...
	t.Run("customer not found is rejected", func(t *testing.T) {
		...
		_, err := svc.CreatePaymentMethod(context.Background(), "org_1", domain.CreatePaymentMethodInput{CustomerId: "cus_x", Token: "tok_1", BillingAddress: addressFor()})
...
func TestCustomerService_UpdatePaymentMethod(t *testing.T) {
	t.Run("updates token and publishes", func(t *testing.T) {
		...
		got, err := svc.UpdatePaymentMethod(context.Background(), "org_1", domain.UpdatePaymentMethodInput{
	...
	t.Run("payment method not found is rejected", func(t *testing.T) {
		...
		_, err := svc.UpdatePaymentMethod(context.Background(), "org_1", domain.UpdatePaymentMethodInput{CustomerId: "cus_1", PaymentMethodId: "pm_x"})

...
func (s *MetadataService) Create(ctx context.Context, input port.CreateMetadataInput) (domain.MetadataStore, error) {
	s.logger.Debug("Creating metadata", "input", input)

	metadata, err := s.metadataRepository.Create(ctx, domain.MetadataStore{
		OrgId:      input.OrgId,
...
func (s *MetadataService) Update(ctx context.Context, input port.UpdateMetadataInput) (domain.MetadataStore, error) {
	...
	// Update the metadata
	metadata, err := s.metadataRepository.Update(ctx, domain.MetadataStore{
		OrgId:      input.OrgId,
		ParentId:   input.ParentId,
...
func (s *MetadataService) GetByKey(ctx context.Context, orgId string, parentId string, key string) (domain.MetadataStore, error) {
...
func (s *MetadataService) GetByParent(ctx context.Context, orgId string, parentId string) ([]domain.MetadataStore, error) {
...
func (s *MetadataService) GetByParentType(ctx context.Context, orgId string, parentType string, key string) ([]domain.MetadataStore, error) {
...
func (s *MetadataService) GetByValue(ctx context.Context, orgId string, key string, value string) ([]domain.MetadataStore, error) {
...
func (s *MetadataService) GetByValueWithoutOrg(ctx context.Context, key string, value string, parentType string) ([]domain.MetadataStore, error) {

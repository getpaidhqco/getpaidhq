...
func (s *SubscriptionOrchestrationService) PauseSubscription(ctx context.Context, input PauseSubscriptionInput) (domain.Subscription, error) {
...
func (s *SubscriptionOrchestrationService) ResumeSubscription(ctx context.Context, input ResumeSubscriptionInput) (domain.Subscription, error) {
...
func (s *SubscriptionOrchestrationService) CancelSubscription(ctx context.Context, input CancelSubscriptionInput) (domain.Subscription, error) {

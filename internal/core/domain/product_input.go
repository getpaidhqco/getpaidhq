...
type CreateProductInput struct {
	...
	Variants    []CreateProductVariantInput `json:"variants" validate:"required,dive"`
}
...
type CreateProductVariantInput struct {
	...
	Description string                    `json:"description"`
	Metadata    map[string]string         `json:"metadata"`
	Prices      []CreateProductPriceInput `json:"prices" validate:"required,dive"`
}
...
type CreateProductPriceInput struct {
	...
	Category           PriceCategory     `json:"category" validate:"required"`
	Scheme             PriceScheme       `json:"scheme" validate:"required"`

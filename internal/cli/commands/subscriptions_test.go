...
func TestSubscriptionsCmd(t *testing.T) {
	// Shared subscription response fixture — JSON-tagged (api.SubscriptionResponse).
	const subResp = `{"id":"sub_1","status":"active","currency":"NGN","billing_interval":"month","billing_interval_qty":1,"renews_at":"2026-07-12T09:00:00Z","created_at":"2026-06-12T09:00:00Z","updated_at":"2026-06-12T09:00:00Z","customer":{"id":"cus_1","email":"ada@example.com","created_at":"2026-06-12T09:00:00Z","updated_at":"2026-06-12T09:00:00Z","billing_address":{}},"order_id":"ord_1","start_date":"2026-06-12T09:00:00Z","billing_anchor":1,"cycles":0,"cycles_processed":0,"total_revenue":0,"retries":0}`
	...
	runCases(t, []cmdCase{
		...
		// ----------------------------------------------------------------
		{
			...
			wantMethod: "PATCH",
			wantPath:   "/api/subscriptions/sub_1",
			wantBody:   `{"id":"","status":"paused","default_payment_method":"","metadata":{"reason":"test"}}`,
			respBody:   subResp,
		...
		// ----------------------------------------------------------------
		{
			...
			respBody:   `{"data":[{"id":"pay_1","status":"successful","currency":"NGN","amount":5000,"reference":"REF001","psp_id":"paystack","order_id":"ord_1","subscription_id":"sub_1","invoice_id":"inv_1","psp_fee":0,"platform_fee":0,"net_amount":5000,"metadata":null,"created_at":"2026-06-12T09:00:00Z","updated_at":"2026-06-12T09:00:00Z"}],"meta":{"total":1,"page":0,"limit":10}}`,
		...
		// ----------------------------------------------------------------
		{
			...
			respBody:   `{"data":[{"id":"inv_1","subscription_id":"sub_1","customer_id":"cus_1","order_id":"ord_1","status":"paid","currency":"NGN","subtotal":5000,"total":5000,"cycle":1,"period_start":"2026-06-12T09:00:00Z","period_end":"2026-07-12T09:00:00Z","line_items":[],"metadata":null,"created_at":"2026-06-12T09:00:00Z","updated_at":"2026-06-12T09:00:00Z"}],"meta":{"total":1,"page":0,"limit":10}}`,
			wantOut:    []string{"inv_1", "paid", "NGN", "5000", "total 1 · page 0 · limit 10"},
			wantCode:   0,
		},
		// ----------------------------------------------------------------
		// usage — raw JSON passthrough
		// ----------------------------------------------------------------
		{

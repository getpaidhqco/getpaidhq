...
func NewApp() (*App, error) {
	...
	invoiceService := service.NewInvoiceService(invoiceRepo, orderRepo, priceRepo, subRepo, usageService, txManager, logger, discountRepo, couponRepo, invoiceSettingsService)

...
func (cc *CustomerHandler) Create(c fuego.ContextWithBody[service.CreateCustomerInput]) (domain.Customer, error) {
...
func (cc *CustomerHandler) CreateCustomerPaymentMethod(c fuego.ContextWithBody[service.CreatePaymentMethodInput]) (domain.PaymentMethod, error) {
	authUser := AuthUserFrom(c)
...
func (cc *CustomerHandler) UpdateCustomerPaymentMethod(c fuego.ContextWithBody[service.UpdatePaymentMethodInput]) (domain.PaymentMethod, error) {
	authUser := AuthUserFrom(c)

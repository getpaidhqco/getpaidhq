...
func NewPaymentRepository(primaryDb lib.Database, logger port.Logger) port.PaymentRepository {
...
func (r PaymentRepository) FindById(ctx context.Context, orgId string, id string) (domain.Payment, error) {
...
func (r PaymentRepository) FindBySubscriptionId(ctx context.Context, orgId string, id string, p domain.Pagination) ([]domain.Payment, int, error) {
	tx := r.getTransactionFromContext(ctx)
...
func (r PaymentRepository) Create(ctx context.Context, entity domain.Payment) (domain.Payment, error) {
	tx := r.getTransactionFromContext(ctx)
...
func (r PaymentRepository) Update(ctx context.Context, entity domain.Payment) (domain.Payment, error) {
	tx := r.getTransactionFromContext(ctx)
...
func paymentEntityToNamedArgs(entity domain.Payment) pgx.NamedArgs {
...
func (r PaymentRepository) FindByPspId(ctx context.Context, orgId string, pspId string) (domain.Payment, error) {
	tx := r.getTransactionFromContext(ctx)
...
func (r PaymentRepository) ListByPspId(ctx context.Context, psp domain.Gateway, pspId string) ([]domain.Payment, error) {
	tx := r.getTransactionFromContext(ctx)

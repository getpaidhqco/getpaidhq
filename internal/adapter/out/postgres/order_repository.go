...
func NewOrderRepository(primaryDb lib.Database, logger port.Logger) port.OrderRepository {
...
func (r OrderRepository) FindById(ctx context.Context, orgId string, id string) (domain.Order, error) {
...
func (r OrderRepository) Create(ctx context.Context, entity domain.Order) (domain.Order, error) {
	tx := r.getTransactionFromContext(ctx)
...
func (r OrderRepository) Update(ctx context.Context, entity domain.Order) (domain.Order, error) {
	tx := r.getTransactionFromContext(ctx)
...
func (r OrderRepository) Find(ctx context.Context, orgId string, p domain.Pagination) ([]domain.Order, int, error) {
	tx := r.getTransactionFromContext(ctx)

...
// on-disk representation is the JSON-encoded form of the string (wrapped in
// quotes). jsonCol[string] handles this: it json.Marshals the string on write
// and unmarshals it on read, so the round-trip matches the schema.

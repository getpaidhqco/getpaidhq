## gphq dunning campaigns communications

List communications for a dunning campaign

### Synopsis

List all customer communications (emails, SMS, etc.) sent for a dunning campaign.

```
gphq dunning campaigns communications <id> [flags]
```

### Examples

```
  gphq dunning campaigns communications dc_1
